...
cancel
The user wants to cancel or stop the current flow.
...
Fabric names include the fabric and the supplier (like Nuhome, JM, SNN, Rivee, etc).
...
Examples:
User: "I think let's see JM Hazel"
fabric = "JM Hazel"

User: "Let's go with NuHome Luna"
fabric = "NuHome Luna"
...
cache = client.caches.create(
    ...
    config=genai.types.CreateCachedContentConfig(
        display_name="furnishing-rules-v3",
...
If the pending question is "dimensions" and the customer sends values
like 84x60, 7ft x 5ft, 84 by 60, etc, you MUST set intent = quotation
and extract height and width.
