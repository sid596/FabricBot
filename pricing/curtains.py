"""Curtain pricing: fabric panels (fullness-adjusted), stitching,
track, and fitting. Moved out of quotation.py unchanged during the
product-type architecture split -- see pricing/blinds.py for the
equivalent module for blinds, and pricing/shared.py for utilities
used by both.
"""
...
def calculate_curtain_quote(
    data: QuotationInput, config: dict[str, Any]
) -> QuotationResult:
